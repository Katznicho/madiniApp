...
export const LINK_CARD = `${BASE_URL}/api/Cards/LinkCard`;
export const LINK_CARD_OTP =  `${BASE_URL}/api/Cards/LinkCardOTP`;
export const VERIFY_CARD_OTP = `${BASE_URL}/api/Cards/VerifyLinkCardOTP`;
export const CARD_DETAILS = `${BASE_URL}/api/Cards/CardAccountDetails`;
